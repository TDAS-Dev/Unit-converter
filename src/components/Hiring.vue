<template>
  <div class="md:py-[96px] sm:py-[64px] md:px-[112px] sm:px-[16px] bg-[#F9FAFB]"> 
    ...
    <div class="flex md:flex-row sm:flex-col-reverse md:justify-center md:mt-[40px] sm:mt-[32px] text-center">
      <button class="text-[#344054] font-500 text-[16px] bg-none rounded-[8px] md:px-[20px] py-[12px] border-[1px] md:mr-[12px] border-[#D0D5DD] shadow-[0_1px_2px_rgba(16,24,40,0.05)]">Learn more</button>
      <button class="text-white font-500 text-[16px] bg-[#7F56D9] rounded-[8px] md:px-[20px] py-[12px] sm:mb-[12px] md:mb-0">Get started</button>
    </div>
  </div>
</template>
